...
python3 pmu_eight_counter.py \
    ...
    --events-per-run 2 \
    --out ../data_raw/charnwood/pmu/eight_counter
...
python3 boundary_correlation.py \
    ...
    --events cycles,instructions,L1D-read-access,L1D-read-miss,LL-read-access,LL-read-miss,DTLB-read-miss,cache-misses \
    --events-per-run 2 \
    --out ../data_raw/charnwood/pmu/boundary_correlation_l1
...
python3 boundary_correlation.py \
    ...
    --events cycles,instructions,L1D-read-access,L1D-read-miss,LL-read-access,LL-read-miss,DTLB-read-miss,cache-misses \
    --events-per-run 2 \
    --out ../data_raw/charnwood/pmu/boundary_correlation_l2
...
python3 boundary_correlation.py \
    ...
    --events cycles,instructions,L1D-read-access,L1D-read-miss,LL-read-access,LL-read-miss,DTLB-read-miss,cache-misses \
    --events-per-run 2 \
    --out ../data_raw/charnwood/pmu/boundary_correlation_llc
